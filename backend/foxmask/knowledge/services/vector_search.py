...
from foxmask.utils.weaviate_client import weaviate_client, WeaviateClass
...
class VectorSearchService:
    async def index_knowledge_item(self, knowledge_item: Dict[str, Any]) -> Optional[str]:
        ...
        try:
            ...
            object_id = await weaviate_client.create_object(
    ...
    async def find_similar_items(
        ...
        try:
            ...
            target_item = await weaviate_client.get_object_by_id(knowledge_item_id)
            ...
            similar_items = await weaviate_client.get_similar_objects(
                class_name=WeaviateClass.KNOWLEDGE_ITEM,
                vector=vector,
    ...
    async def batch_index_items(self, knowledge_items: List[Dict[str, Any]]) -> List[str]:
        ...
        try:
            ...
            object_ids = await weaviate_client.batch_upload_objects(
                class_name=WeaviateClass.KNOWLEDGE_ITEM,
                objects=objects
            )
    ...
    async def get_index_statistics(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            stats = await weaviate_client.get_class_statistics(WeaviateClass.KNOWLEDGE_ITEM)
            return stats
    ...
    async def delete_from_index(self, knowledge_item_id: str) -> bool:
        ...
        try:
            ...
            if items and "_additional" in items[0]:
                ...
                return await weaviate_client.delete_object(weaviate_id)

...
export const OFFICIAL_URL = 'https://foxmask.com';
export const OFFICIAL_PREVIEW_URL = 'https://chat-preview.lobehub.com';
export const OFFICIAL_SITE = 'https://lobehub.com';

export const OG_URL = '/og/cover.png?v=1';

export const GITHUB = 'https://github.com/qifarer/foxmask';
export const GITHUB_ISSUES = urlJoin(GITHUB, 'issues/new/choose');
export const CHANGELOG = 'https://lobehub.com/changelog';
export const DOCKER_IMAGE = 'https://hub.docker.com/r/qifarer/foxmask';
...
export const FEEDBACK = 'https://github.com/qifarer/foxmask/issues/new/choose';
...
export const MORE_MODEL_PROVIDER_REQUEST_URL =
  'https://github.com/qifarer/foxmask/discussions/6157';

export const MORE_FILE_PREVIEW_REQUEST_URL =
  'https://github.com/qifarer/foxmask/discussions/3684';

export const AGENTS_INDEX_GITHUB = 'https://github.com/qifarer/foxmask-agents';
...
export const FOXMASK_URL_IMPORT_NAME = 'settings';

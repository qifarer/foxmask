...
const transformOpenAIStream = (
  ...
  try {
    ...
    if (item.delta) {
      ...
      // refs: https://github.com/qifarer/foxmask/issues/5681 (siliconflow)
      // refs: https://github.com/qifarer/foxmask/issues/5956 (aliyun bailian)

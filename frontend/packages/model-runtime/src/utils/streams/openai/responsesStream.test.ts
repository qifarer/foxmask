          ...
          tools: [
            {
              ...
              name: 'foxmask-web-browsing____search____builtin',
              parameters: {
                properties: {
            ...
            },
            {
              ...
              name: 'foxmask-web-browsing____crawlSinglePage____builtin',
              parameters: {
            ...
            },
            {
              ...
              name: 'foxmask-web-browsing____crawlMultiPages____builtin',
              parameters: {
                properties: {
                  urls: {

...
import { imageUrlToBase64, safeParseJSON } from '@foxmask/utils';
...
export class LobeGoogleAI implements LobeRuntimeAI {
  ...
  async chat(rawPayload: ChatStreamPayload, options?: ChatMethodOptions) {
    try {
      ...
      const config: GenerateContentConfig = {
        ...
        // refs: https://github.com/qifarer/foxmask/pull/1418
        safetySettings: [
          {
  ...
  private convertToolToGoogleTool = (tool: ChatCompletionTool): FunctionDeclaration => {
    ...
    // refs: https://github.com/qifarer/foxmask/pull/5002
    const properties =

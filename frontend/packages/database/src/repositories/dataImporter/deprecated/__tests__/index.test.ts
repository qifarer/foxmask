          ...
          sessions: [
            {
              ...
              meta: {
                avatar: '📝',
                description:
                  'FoxMask is an AI conversation application built with the Next.js framework. I will help you write the development documentation for FoxMask.',
                tags: [
                ...
                title: 'FoxMask Technical Documentation Expert',
              },
              type: 'agent',

...
describe('switchLang', () => {
  ...
  it('should change language to the specified locale', () => {
    ...
    expect(setCookie).toHaveBeenCalledWith(FOXMASK_LOCALE_COOKIE, locale, 365);
  });
  ...
  it('should change language based on navigator.language when locale is "auto"', () => {
    ...
    expect(setCookie).toHaveBeenCalledWith(FOXMASK_LOCALE_COOKIE, undefined, 365);
  });
});

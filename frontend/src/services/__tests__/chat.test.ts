...
import { ModelRuntime } from '@foxmask/model-runtime';
          ...
          tool_calls: [
            {
              function: {
                arguments:
                  '{"query":"FoxMask","searchEngines":["brave","google","duckduckgo","qwant"]}',
...
<!-- END SYSTEM CONTEXT -->`,
    ...
    it('should inject INBOX_GUIDE_SYSTEMROLE for welcome questions in inbox session', async () => {
      ...
      expect(systemMessage!.content).toContain('FoxMask Support Assistant');

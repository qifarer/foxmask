import {
  ...
  ModelProvider,
  ModelRuntime,
} from '@foxmask/model-runtime';
import { BuiltinSystemRolePrompts, filesPrompts } from '@foxmask/prompts';
import { ChatErrorType, TracePayload, TraceTagMap } from '@foxmask/types';
...
export function initializeWithClientStore(provider: string, payload?: any) {
   ...
   * @see https://github.com/qifarer/foxmask/pull/5267
...
class ChatService {
   ...
   * see https://github.com/qifarer/foxmask/pull/3155
   */

...
import {
  FOXMASK_THEME_APPEARANCE,
  FOXMASK_THEME_NEUTRAL_COLOR,
  FOXMASK_THEME_PRIMARY_COLOR,
} from '@/const/theme';
...
const AppTheme = memo<AppThemeProps>(
  ({
    ...
    useEffect(() => {
      setCookie(FOXMASK_THEME_PRIMARY_COLOR, primaryColor);
    }, [primaryColor]);

    useEffect(() => {
      setCookie(FOXMASK_THEME_NEUTRAL_COLOR, neutralColor);
    }, [neutralColor]);
    ...
    return (
      <ThemeProvider
        ...
        onAppearanceChange={(appearance) => {
          ...
          setCookie(FOXMASK_THEME_APPEARANCE, appearance);
        }}
        theme={{
          cssVar: true,
          token: {

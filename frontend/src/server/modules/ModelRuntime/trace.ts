import { ChatStreamCallbacks, ChatStreamPayload } from '@foxmask/model-runtime';
import { TracePayload, TraceTagMap } from '@foxmask/types';
...
export const createTraceOptions = (
  ...
  return {
    ...
    headers: {
      [FOXMASK_OBSERVATION_ID]: generation?.id,
      [FOXMASK_TRACE_ID]: trace?.id,
    },
  };
};

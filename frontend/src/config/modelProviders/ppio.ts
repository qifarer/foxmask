...
const PPIO: ModelProviderCard = {
  ...
  modelsUrl:
    'https://ppinfra.com/llm-api?utm_source=github_foxmask&utm_medium=github_readme&utm_campaign=link',
  name: 'PPIO',
  settings: {
    disableBrowserRequest: true,
    sdkType: 'openai',
  ...
  url: 'https://ppinfra.com/user/register?invited_by=RQIMOC&utm_source=github_foxmask',
};

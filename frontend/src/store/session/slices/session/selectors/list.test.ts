import { DEFAULT_AGENT_FOXMASK_SESSION } from '@/const/session';
...
describe('getSessionById', () => {
  ...
  it('should return initLobeSession when the session with the specified id does not exist', () => {
    expect(sessionSelectors.getSessionById('3')(s)).toEqual(DEFAULT_AGENT_FOXMASK_SESSION);
  });
});
